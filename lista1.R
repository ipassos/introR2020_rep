...
# utilie a função names() - referência: https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/names

#8 - Faça a soma das colunas. Armazene cada soma em uma nova variável (inclusive do vetor soma). 

#9 - Verifique se o mês de janeiro dos EUA tem valor maior que o mesmo mês do Brasil. 
